...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class='card $card_class mb-3' style='max-width: 18rem;'>
           <form action='' method='post'><input type='hidden'><div class='card-header headercard'>Schedule <button style='border:none; background-color:transparent;' name='removesched'><div class='container-fluid trashsasched'><i class='fa-solid fa-trash text-danger'></i></div></button></div></form> 
            <div class='card-body'>
