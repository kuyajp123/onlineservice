...
if (isset($_POST['submit_profile'])) { // Fixed typo in 'submit_profile'
    if (isset($user_no)) {
        if (isset($_FILES['profilepicture']) && $_FILES['profilepicture']['error'] === UPLOAD_ERR_OK) {
            $profilepicture = $_FILES['profilepicture']['name'];
            $tmp_profilepicture = $_FILES['profilepicture']['tmp_name'];
            $upload_path = "../users/images/profilepicture/" . basename($profilepicture); // Use $profilepicture here

            if (move_uploaded_file($tmp_profilepicture, $upload_path)) { // Fixed variable name
