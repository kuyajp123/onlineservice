...
$valid_columns = ['fname', 'lname', 'user_no', 'student_no', 'email', 'ban_id', 'warning_level', 'ban_level'];
...
?>
    <div class="container mt-4 ">
        ...
        <table class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th scope="col" class="sortable <?php echo ($sort_column == 'ban_id') ? ($sort_direction == 'asc' ? 'asc' : 'desc') : ''; ?>" onclick="sortTable('ban_id')">ID<i class="fa-solid fa-sort-up"></i><i class="fa-solid fa-sort-down"></i></th>
            ...
            <tbody>
                ...
                while ($user = $usersResult->fetch_assoc()): ?>
                    <tr>
                        <th scope="row"><?php echo htmlspecialchars($user['ban_id']); ?></th>
